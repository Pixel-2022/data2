...
while cap.isOpened():
    ...
    cv2.putText(img, f'{this_action.upper()}', org=(int(img.shape[1]/2),int(img.shape[0]/2)), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(255, 255, 255), thickness=2)
